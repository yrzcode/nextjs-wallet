...
- **CreateMode**: New transaction creation modal with comprehensive form interaction testing
- **EditMode**: Existing transaction modification modal with pre-filled data validation
- **EditWithdrawal**: Withdrawal transaction editing with specific data verification
- **Closed**: Modal closed state verification testing
- **Interactive**: Modal opening/closing interaction testing with user actions
- **ValidationTesting**: Form validation testing with invalid data scenarios
- **Form interactions**: Step-by-step input validation, field interactions, and submission testing
- **Modal behavior**: Proper dialog management, focus handling, and accessibility verification
- **ARIA compliance**: Accessible form labels, error announcements, and modal attributes
- **User feedback**: Toast notifications, validation messages, and error state handling
- **Field testing**: Amount input validation, content textarea interactions, and dropdown selection
- **State management**: Pre-filled data verification, form clearing, and data modification testing
